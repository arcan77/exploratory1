...
with(FilteredDates, plot(DateTime, Global_active_power, xlab=NA, ylab="Global Active Power (kilowatts)",lty=1, lwd=1, pch=".", type="n"))
with(FilteredDates, lines(DateTime, Global_active_power, xlab=NA, ylab="Global Active Power (kilowatts)",lty=1, lwd=1, pch="."))
